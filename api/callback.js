...
O ponto importante:
O Decap espera receber via postMessage:

authorization:github:success:{"token":"...","provider":"github"}

Sem o campo provider, ele pode autorizar no GitHub, mas voltar
para a tela de login do CMS.
  ...
  <body>
    ...
    <script>
      (function () {
        ...
        if (window.opener) {
          // Handshake esperado pelo Decap.
          window.opener.postMessage('authorizing:github', '*');
        }

        // Fallback caso o handshake não volte.
        setTimeout(function () {
          sendAuthorization('*');
        }, 1600);
