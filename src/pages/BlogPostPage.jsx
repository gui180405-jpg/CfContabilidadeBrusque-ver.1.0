...
function BlogImageFallback({ category }) {
  return (
    <div className="relative flex h-full min-h-[260px] w-full items-center justify-center overflow-hidden rounded-[1.5rem] bg-gradient-to-br from-slate-900 via-sky-950 to-sky-700 p-8">
...
export default function BlogPostPage({ slug, navigate, onStartQuiz }) {
  ...
  return (
    <section className="min-h-screen bg-[#eef1f4]">
      <div className="relative overflow-hidden bg-slate-950 px-5 pb-24 pt-32 md:px-8 md:pb-28 md:pt-36">
      ...
      <article className="relative px-5 pb-20 md:px-8 md:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <div className="mt-8 rounded-[2rem] border border-white/70 bg-white/90 p-7 shadow-xl shadow-slate-900/8 backdrop-blur md:p-10 lg:p-12">
            ...
            <div className="mt-12 rounded-[1.5rem] bg-slate-950 p-7 shadow-2xl shadow-slate-950/15 md:p-8">
